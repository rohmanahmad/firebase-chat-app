(function (factory) {
    if (typeof module === "object" && typeof module.exports === "object") {
        ...
        define(["require", "exports", "firebase/app", "firebase/firestore/lite"], factory);
    }
    ...
    class ChatModule extends Firebase {
        constructor() {
            super();
            this.logo = '<svg xmlns="http://www.w3.org/2000/svg" class="w-10 h-10 text-white" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2"><path stroke-linecap="round" stroke-linejoin="round" d="M8 10h.01M12 10h.01M16 10h.01M9 16H5a2 2 0 01-2-2V6a2 2 0 012-2h14a2 2 0 012 2v8a2 2 0 01-2 2h-5l-5 5v-5z" /></svg>';
            this.mainSelector = 'jne-widget-chat';
        }
        handle() {
            this.initDatabase();
            debugger;
        ...
        togglePopup() {
            var _a;
            if (!this.chatPopup)
                throw new Error('Invalid chapPopup Component');
            this.chatPopup.classList.toggle('hidden');
            if (!this.chatPopup.classList.contains('hidden')) {
                (_a = document.getElementById('chat-input')) === null || _a === void 0 ? void 0 : _a.focus();
            }
        }
        addChatText(message) {
        ...
        `;
            ...
            if (!this.chatInput)
                throw new Error('Invalid chatInput');
        ...
        `;
            if (!this.chatMessages)
                throw new Error('Invalid chatMessages');
        ...
        registerEvents() {
            ...
            if (!this.chatInput)
                throw new Error('Invalid chatInput');
            if (!this.chatSubmit)
                throw new Error('Invalid chatSubmit');
            if (!this.chatMessages)
                throw new Error('Invalid chatMessages');
            if (!this.chatBubble)
                throw new Error('Invalid chatBubble');
            if (!this.chatPopup)
                throw new Error('Invalid chatPopup');
            if (!this.closePopup)
                throw new Error('Invalid closePopup');
            ...
            if (this.chatSubmit) {
                (_a = this.chatSubmit) === null || _a === void 0 ? void 0 : _a.addEventListener('click', () => {
                    var _a, _b;
                    const message = (_a = this.chatInput) === null || _a === void 0 ? void 0 : _a.value.trim();
                    if (!message)
                        return;
                    if (this.chatMessages)
                        this.chatMessages.scrollTop = (_b = this.chatMessages) === null || _b === void 0 ? void 0 : _b.scrollHeight;
                    if (this.chatInput)
                        this.chatInput.value = '';
            ...
            if (this.chatInput) {
                this.chatInput.addEventListener('keyup', event => {
                    var _a;
                    if (event.key === 'Enter') {
                        (_a = this.chatSubmit) === null || _a === void 0 ? void 0 : _a.click();
                    }
                });
            }
            if (this.chatBubble) {
            ...
            (_b = this.closePopup) === null || _b === void 0 ? void 0 : _b.addEventListener('click', () => {
                this.togglePopup();
            });
        }
    }
